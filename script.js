...
// ===== Tesla Main Gallery Fade Animation (on main image) =====
$(document).ready(function(){
  ...
  $("#nextTeslaMain").click(function(){
    $("#teslaMainGallery").fadeOut(500, function(){
      mainIndex = (mainIndex + 1) % teslaMainImgs.length;
      $(this).attr("src", teslaMainImgs[mainIndex]).fadeIn(500);
    });
  });
});
 // ===== jQuery Selectors & Effects Demo (index.html) =====
